...
CONFIG_PATH = "/StarGAN_v2/Configs/config.yml"
MEL_PARAMS = {
            "n_mels": 80,
            "n_fft": 2048,
            "win_length": 1200,
...
def get_svm(path='/exp/IS2023/emotion-classifier/SVM/model/svm_tess+ravdess/ravdess_tess_esd_5emotion_24k.pkl'):
...
def get_vocoder(path="/StarGAN_v2/checkpoint-1790000steps.pkl"):
