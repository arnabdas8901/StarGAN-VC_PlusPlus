...
val_path = "/scratch/ardas/dataset/ESD/Emotional Speech Dataset (ESD)/English_sub_set/val_list_single.txt"
...
val_dataloader = build_dataloader(val_list,
                                  ...
                                  device=device,
                                  domain=domain)
_ = Emo_classifier.classifier.eval()
...
for i, batch in enumerate(val_dataloader):
    ...
    print(op)
    print(torch.nn.Softmax(dim=-1)(op))
    print("#"*30)